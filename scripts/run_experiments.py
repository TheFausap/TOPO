...
EXPERIMENTS: dict[str, Experiment] = {
    ...
    "darcy_holes_flux_blobs_none": Experiment(
        name="darcy_holes_flux_blobs_none",
        args=(
            "--task",
            "darcy_holes_flux",
            "--darcy-orientation",
    ...
    "darcy_holes_tri_meshes_flux_blobs_none": Experiment(
        name="darcy_holes_tri_meshes_flux_blobs_none",
        args=(
            "--task",
